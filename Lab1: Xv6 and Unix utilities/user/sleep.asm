...
main(int argc, char *argv[]) 
{
   ...
   e:	02a7d063          	bge	a5,a0,2e <main+0x2e>
		fprintf(2, "please use sleep numbers...\n");
	}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 396:	4b650513          	addi	a0,a0,1206 # 848 <digits>
 39a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 456:	39ec8c93          	addi	s9,s9,926 # 7f0 <malloc+0x110>
 ...
 58a:	26298993          	addi	s3,s3,610 # 7e8 <malloc+0x108>
        while(*s != 0){
 58e:	85ee                	mv	a1,s11
 ...
 694:	00e6ea63          	bltu	a3,a4,6a8 <free+0x4a>
{
 ...
 6d6:	18f73723          	sd	a5,398(a4) # 860 <freep>
}
 6da:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 708:	15c53503          	ld	a0,348(a0) # 860 <freep>
 ...
 730:	13490913          	addi	s2,s2,308 # 860 <freep>
  if(p == (char*)-1)
 734:	5afd                	li	s5,-1
 736:	a895                	j	7aa <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 738:	00000797          	auipc	a5,0x0
 73c:	13078793          	addi	a5,a5,304 # 868 <base>
 740:	00000717          	auipc	a4,0x0
 744:	12f73023          	sd	a5,288(a4) # 860 <freep>
 748:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 76c:	0ea73c23          	sd	a0,248(a4) # 860 <freep>
      return (void*)(p + 1);
